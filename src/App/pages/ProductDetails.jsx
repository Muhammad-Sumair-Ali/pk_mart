    ...
    <div className="md:container px-4 md:px-10 mx-auto">
      ...
      <div className="flex flex-col lg:flex-row gap-2 md:gap-8 mt-2">
        ...
        <div className="lg:w-1/3">
          ...
          {/* Additional Info */}
          <div className="mt-6 flex flex-col gap-2 md:flex-row md:items-center md:justify-between bg-gray-50 p-4 w-4/3 rounded-lg shadow-sm">
            ...
            className="flex items-center gap-2 px-4 py-2 bg-green-50 text-green-600 rounded-md shadow hover:bg-green-100 transition duration-300 ease-in-out">
              <svg
              ...
              <span className="text-sm font-medium">Save to My Mart</span>
            </button>
          </div>
