      ...
      <div className="w-full px-1 md:px-4 mx-auto 2xl:px-0 py-2">
        <div className="flex items-center justify-between ">
          ...
          <div className={showSearch ? "block w-full md:w-2/4" : "hidden"}>
            <div className="flex items-center w-full sm:h-14 h-12 px-1 bg-gray-300/75 rounded-md shadow-sm">
              <input
                type="search"
                id="search-dropdown"
          ...
          <div className="flex items-center lg:space-x-2 relative">
            ...
            <span className="px-1 hidden md:block" onClick={handleDropdownToggle}>
              <svg
